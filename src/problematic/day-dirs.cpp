/************************************************************************************************************\
 * Program name:  Day-Dirs
 * File name:     day-dirs.cpp
 * Source for:    day-dirs.exe
 ...
 *    Fri Feb 05, 2010 - Renamed from "Day-Of-Month Dirs" to "Day Dirs".
\************************************************************************************************************/
...
void Help (void)
{
   cout
                                                                                        << endl
   << "Welcome to Day Dirs, Robbie Hatley's 01-31 directory-set creator."               << endl
                                                                                        << endl
   << "This version was compiled at " << __TIME__ << " on "<< __DATE__ << "."           << endl
                                                                                        << endl
   << "Day Dirs creates 31 empty subdirectories in the current directory,"              << endl
   << "named \"01\" through \"31\".  This is especially useful for sorting files by"    << endl
   << "date, using nested year/month/day folders."                                      << endl
                                                                                        << endl
   << "Day Dirs ignores any arguments except for the -h or --help switches,"            << endl
