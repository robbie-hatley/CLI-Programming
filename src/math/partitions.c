/*
partitions.c
Prints the numbers P(n) of ways of partitioning non-negative integers from 0 through argument n into
...
int main (int Beren, char * Luthien[])
{
   ...
   // With the preliminaries out of the way, let's get to calculating and printing P(i) for i values from 0 through n:
   NumberOfPartitions(p, n); // Calculate P(i) for all integers from 0 through n and store in array PTable.
   for ( i = 0 ; i <= n ; ++i )
   {
