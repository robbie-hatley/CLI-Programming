...
########################################################################################################################
# utcmed.pl
# Prints current UTC time and date in "04:36:40 Fri Feb 05, 2021, UTC" format.
...
# Tue Sep 22, 2020: Changed name of this version from "date.pl" to "utcmed.pl".
...
print POSIX::strftime("%T %a %b %d, %Y, UTC",$sec,$min,$hour,$mday,$mon,$year);
