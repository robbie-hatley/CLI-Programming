...
########################################################################################################################
# local-date-short.pl
# Prints current local date in "2016-07-04" format.
...
# Tue Sep 22, 2020: Changed name of this version from "date.pl" to "dateshort.pl"
# Thu Feb 04, 2021: Fixed "no newline at end" bug, cleaned-up comments and formatting, and changed name
#                   from "dateshort.pl" to "local-date-short.pl".
...
print POSIX::strftime(  "%4Y-%2m-%2d", 0, 0, 0, $mday, $mon, $year);
