...
########################################################################################################################
# local-time-date.pl
# Prints current local time and date in " 8:23:12 PM PST, Thursday February  4, 2021" format.
...
# Tue Sep 22, 2020: Changed name of this version from "date.pl" to "local-time-date.pl".
