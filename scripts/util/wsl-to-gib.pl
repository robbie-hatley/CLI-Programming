...
# which has a 64-character "Windows Spotlight"-style file name to a name consisting of 8 lower-case letters
# followed by the original file name extension.
#
# Edit history:
...
# Mon Feb 15, 2021: Dramatically simplied, removed extension discrimination (extensions can now be any or none),
#                   and renamed to "wsl-to-gib.pl".
...
sub help ()
{
   ...
   Welcome to "wsl-to-gib.pl". This program renames all regular files in the
