...
# Tue Sep 22, 2020: Changed name of this version from "date.pl" to "datemed.pl"
# Thu Feb 04, 2021: Fixed "no newline at end" bug, cleaned-up comments and formatting, and changed name
#                   from "datemed.pl" to "local-date-medium.pl".
...
print POSIX::strftime(  "%a %b %d, %Y",$sec,$min,$hour,$mday,$mon,$year);
