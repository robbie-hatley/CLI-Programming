...
; ------------------------------------------------------------------------------
;
;   Little Freckles Twiddletooth's Nifty Doodle Dance Trainer
;   (This will only work for Little Freckles Twiddletooth.)
;
; ------------------------------------------------------------------------------
...
Func TrainDoodles()
   ...
   HereBoy(3)
   While (1)
      WinActivate("Toontown")    ; Activate Toontown window.
      For $i = 1 to 5            ; Repeat following command group 5 times.
         HereBoy(7)              ;   Say "Here boy!" 7 times.
         Trick(7, 7)             ;   Say "Dance!" 7 times.
         PraiseDoodles(4)        ;   Praise doodles 4 times.
      Next                       ; Loop.
      FeedAndScratchDoodles()    ; Feed and scratch all doodles.
      Sleep(40000)               ; Let doodles rest for 40 seconds.
   Wend
EndFunc
