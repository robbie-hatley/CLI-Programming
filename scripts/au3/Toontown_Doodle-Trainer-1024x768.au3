...
; ALSO VERY, VERY IMPORTANT: THIS VERSION WILL ONLY WORK WITH 1024X768
; MONITOR RESOLUTION.   FOR OTHER RESOLUTIONS, THIS SCRIPT MUST BE ALTERED.
; VERTICAL: 0.75  HORIZONTAL: 0.8
...
Global $PetsBase   =  20.25  ; base vertical position for pets
Global $MenuIncr   =  24.75  ; menu increment
...
Global $BttnCol  = 78   ; SpeedChat Button   Column
Global $SchtCol  = 136  ; SpeedChat Commands Column
Global $PcomCol  = 280  ; Pet       Commands Column
Global $TrixCol  = 356  ; Pet       Tricks   Column


;===============================================================================
; Pet List Variables:

Global $PnamBase   =  148 ; vertical  base      for pet names
Global $PnamIncr   =   17 ; vertical  increment for pet names 
Global $PnamCol    =  880 ; Horizonal position  for pet names
...
Func CloseFriendInfo()
   MouseMove ( 996, 356, 0)   ; Close "Friend Info" panel (if any)
   Sleep(125)
...
Func ClosePetInfo()
   MouseMove ( 996, 254, 0)   ; Close "Pet Info" panel (if any)
   Sleep(125)
   MouseClick("Left")         ; click
   Sleep(125)
EndFunc
...
Func OpenFriends()
   MouseMove ( 975, 63, 0)    ; Open "Friends" panel
   Sleep(125)
   MouseClick("Left")         ; click
   Sleep(125)
EndFunc
...
Func OpenPetsMenu()
   ...
   CloseFriendInfo()
   OpenFriends()
   MouseMove ( 880, 335, 0)   ; Left Arrow
   Sleep(125)
   MouseClick("Left")         ; click
   Sleep(500)
   MouseClick("Left")         ; click
