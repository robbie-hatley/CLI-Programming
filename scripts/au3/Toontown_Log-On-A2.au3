...
; ---------------------------------------------------------------------------------
;   Robbie Hatley's Toontown Acct 2 Log-On Script
;   Logs back on to my Toontown Acct 2.
;   (Works best when Launcher-2 is first launched by my Acct-2 launch script.)
; ---------------------------------------------------------------------------------
